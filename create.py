...
def create_new_questionbank(parent):
    ...
    def create():
        cur.execute("DROP TABLE IF EXISTS module1, module2, module3, module4, module5, qpmod1, qpmod2, qpmod3, qpmod4, qpmod5")
        cur.execute("CREATE TABLE module1(snno int PRIMARY KEY AUTO_INCREMENT, module_1_questions text)")
        cur.execute("CREATE TABLE module2(snno int PRIMARY KEY AUTO_INCREMENT, module_2_questions text)")
        cur.execute("CREATE TABLE module3(snno int PRIMARY KEY AUTO_INCREMENT, module_3_questions text)")
        cur.execute("CREATE TABLE module4(snno int PRIMARY KEY AUTO_INCREMENT, module_4_questions text)")
        cur.execute("CREATE TABLE module5(snno int PRIMARY KEY AUTO_INCREMENT, module_5_questions text)")
